            ...
            <div class="card-body p-4">
              ...
              <div class="list-group list-group-flush">
                <div class="list-group-item p-3 d-flex align-items-center">
                  <div class="me-3">
                    <img src="{{ asset('assets/images/product-1.png') }}" alt="Product A" class="rounded" style="width:48px; height:48px; object-fit:cover;">
                  </div>
                ...
                <div class="list-group-item p-3 d-flex align-items-center">
                  <div class="me-3">
                    <img src="{{ asset('assets/images/product-2.png') }}" alt="Product B" class="rounded" style="width:48px; height:48px; object-fit:cover;">
                  </div>
                  <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-center">
                      <div>
                ...
                <div class="list-group-item p-3 d-flex align-items-center">
                  <div class="me-3">
                    <img src="{{ asset('assets/images/product-3.png') }}" alt="Product C" class="rounded" style="width:48px; height:48px; object-fit:cover;">
                  </div>
                  <div class="flex-grow-1">
                    <div class="d-flex justify-content-between align-items-center">
                      <div>
